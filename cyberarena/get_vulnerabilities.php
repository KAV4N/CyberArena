...
/*
$sql_blog = "INSERT INTO blog_posts (title, content, author_id, created_at,category_id,blog_picture) VALUES ('Virus', 'wheeeeeeeeeeeee', 1, '$date',2,'https://www.lifewire.com/thmb/wt75J7f72UaQ3Talhk7_L1B7gwo=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/how-to-tell-if-your-pc-has-a-virus-4590200-0-26a9bbbdc3d64c12950a58506fd9aaf7.jpg')";
...
$sql = "SELECT blog_posts.id_blog, blog_posts.title, blog_posts.blog_picture, blog_posts.blog_video, blog_posts.content, users.username, blog_posts.created_at, categories.id_category, GROUP_CONCAT(categories.name SEPARATOR ', ') AS categories
    ...
    LEFT JOIN categories ON blog_posts.category_id = categories.id_category WHERE categories.name = 'Vulnerability'
